...
| **API keys** | **No provider key ever ships in the client** (OWASP M1). All LLM calls route through a Supabase Edge Function → LiteLLM proxy. |
...
| **Rate limiting** | Hard per-user budgets and RPM caps at the LiteLLM proxy. |

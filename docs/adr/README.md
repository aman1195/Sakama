...
| [0006](0006-litellm-gateway-byok-hybrid.md) | LiteLLM gateway with hybrid BYOK | Accepted |
| [0007](0007-plan-engine-as-json-data.md) | Plans are JSON data, never hardcoded logic | Accepted |
| [0008](0008-indian-food-database-strategy.md) | Indian food DB: INDB + USDA + OFF, never IFCT | Accepted |
